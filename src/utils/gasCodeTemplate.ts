 ...
 * 3. **สร้างและแนบไฟล์แบบฟอร์มทางการ PDF A4 (พร้อมตราสัญลักษณ์และข้อมูลครบถ้วน)**
 *    ไปพร้อมกับอีเมลแจ้งเตือนในทุกขั้นตอน เพื่อให้ผู้เกี่ยวข้องเปิดดูรายละเอียดได้ทันที
 * ==============================================================================
 */
...
/**
 * จัดการคำขอ POST จาก Web Application (บันทึกข้อมูล, อัปเดตสถานะ, ส่งอีเมลพร้อมแนบ PDF A4)
 */
function doPost(e) {
  try {
    let data;
